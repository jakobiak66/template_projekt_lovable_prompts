...
export const Route = createFileRoute("/leistungen/glasreinigung")({
  head: () => ({
    meta: [
      {
        title:
          "Glasreinigung Berlin – Streifenfreie Fenster & Fassaden | PutzKraft24",
      },
      {
        name: "description",
        content:
          "Professionelle Glasreinigung in Berlin: Fenster, Glastrennwände und Fassaden — streifenfrei, termingerecht und mit festem Stammteam. Jetzt Angebot anfordern!",
      },
    ],
  }),
  component: GlasreinigungPage,
});

const heroBullets = [
  "Streifenfrei & termingerecht",
  "Fenster, Glaswände & Fassaden",
...
const sustainabilityPoints = [
  ...
  "Klare Sicht und gepflegte Fassaden — für ein professionelles Erscheinungsbild",
];

const services = [
  { icon: Sparkles, title: "Glas- und Fassadenreinigung", note: "Ab 30 €/Std." },
              ...
              <div className="px-8 py-16 md:px-14 md:py-20 lg:py-24">
                <div className="max-w-xl text-white">
                  <h1 className="text-3xl font-extrabold leading-tight md:text-4xl lg:text-5xl">
                    Professionelle Glasreinigung in Berlin — Streifenfrei & termingerecht
                  </h1>
                  <p className="mt-5 text-base text-white/85 md:text-lg">
                    Suchen Sie eine zuverlässige Glasreinigung in Berlin?
                    PutzKraft24 reinigt Fenster, Glastrennwände und Fassaden
                    Ihres Büros — streifenfrei, sicher und auf Wunsch
                    regelmäßig. Jetzt Angebot anfordern!
                  </p>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 md:grid-cols-2 md:px-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground md:text-3xl">
                Was umfasst unsere Glasreinigung in Berlin?
              </h2>
              <p className="mt-5 text-foreground/75 leading-relaxed">
                Saubere Fenster und glänzende Glasflächen sind das Aushängeschild
                Ihres Büros. Als spezialisierte Reinigungsfirma sorgen wir für
                klare Sicht — egal ob im Erdgeschoss oder in der Höhe, einmalig
                oder regelmäßig.
              </p>
              ...
              <ul className="mt-3 space-y-2 text-sm text-foreground/80">
                {[
                  ...
                  "Reinigung von Glastrennwänden und Türen",
                  "Fassaden- und Wintergartenreinigung",
                  "Rahmen-, Beschlag- und Fensterbankpflege",
                ].map((t) => (
              ...
              >
                <Link to="/kontakt">
                  Ihre Experten für Glasreinigung
                  <span className="ml-3 flex h-8 w-8 items-center justify-center rounded-full bg-white/25">
                    <ChevronRight className="h-4 w-4" />
                  </span>
                </Link>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 md:grid-cols-2 md:px-6">
            <div>
              ...
              <h2 className="mt-5 text-2xl font-bold text-foreground md:text-3xl">
                Nachhaltige Glasreinigung für umweltbewusste Unternehmen
              </h2>
              <p className="mt-4 text-foreground/75 leading-relaxed">
                Auch bei der Glasreinigung setzt PutzKraft24 auf biologisch
                abbaubare Mittel und wassersparende Verfahren — ohne Mehrkosten
                für Sie.
              </p>
              <h3 className="mt-6 font-semibold text-foreground">
            ...
            <div className="overflow-hidden rounded-2xl bg-background">
              <img
                src={teamBerlin}
                alt="PutzKraft24 Reinigungsteam Berlin — Glasreinigung"
                className="h-full w-full object-cover"
                loading="lazy"
              />
            </div>
        ...
        <section className="bg-background py-16">
          <div className="mx-auto max-w-5xl px-4 md:px-6">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-center text-foreground/75 leading-relaxed">
              Neben der Glasreinigung bieten wir Ihnen das komplette
