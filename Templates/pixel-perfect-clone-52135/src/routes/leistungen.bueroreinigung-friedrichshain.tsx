...
import friedrichshainHero from "@/assets/friedrichshain-hero.jpg";
...
export const Route = createFileRoute("/leistungen/bueroreinigung-friedrichshain")({
  head: () => ({
    meta: [
      { title: "Büroreinigung Friedrichshain | PutzKraft24" },
      {
        name: "description",
        content:
          "Professionelle Büroreinigung in Berlin-Friedrichshain – zuverlässig, gründlich und mit festem Stammteam. Jetzt kostenloses Angebot anfordern.",
      },
    ],
  }),
  component: FriedrichshainPage,
});

const bullets = [
  "Ihr Top-Partner in Berlin-Friedrichshain",
...
function FriedrichshainPage() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main>
        {/* HERO with Friedrichshain landmark */}
        <section className="relative overflow-hidden">
          <img
            src={friedrichshainHero}
            alt="Büroreinigung Friedrichshain – Berliner Skyline mit Spree und Brücke"
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
            <div className="max-w-2xl text-white">
              <h1 className="text-4xl font-extrabold leading-[1.05] md:text-5xl lg:text-6xl">
                Büroreinigung Friedrichshain
              </h1>
              <p className="mt-6 text-base text-white/90 md:text-lg">
                Suchen Sie eine zuverlässige Büroreinigung in Berlin-Friedrichshain?
                PutzKraft24 ist Ihr Top-Partner in Berlin-Friedrichshain für gründliche
        ...
        {/* Section: Tech-Büros Ostkreuz / Mediaspree */}
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 md:grid-cols-2 md:px-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-foreground md:text-4xl">
                Reinigung für moderne Tech-Büros am Ostkreuz und Mediaspree
              </h2>
              <p className="mt-6 text-base leading-relaxed text-foreground/75">
                Berlin-Friedrichshain ist ein Magnet für Technologie- und
                Digitalunternehmen. Wir bieten eine spezialisierte Büroreinigung für
                flexible Arbeitsumgebungen mit modernen Hygienekonzepten.
              </p>
              <h3 className="mt-8 text-lg font-bold text-foreground">
                Unsere Leistungen für moderne Tech-Büros in Berlin-Friedrichshain:
              </h3>
              ...
              >
                Ihre Experten für Büro- &amp; Gebäudereinigung in Berlin-Friedrichshain
        ...
        <section className="bg-background py-20">
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 md:grid-cols-2 md:px-6">
            ...
            <div className="md:order-1">
              <h2 className="text-3xl font-bold text-foreground md:text-4xl">
                Kreative Spaces sauber halten – Büroreinigung für Startups
              </h2>
              <p className="mt-6 text-base leading-relaxed text-foreground/75">
                Loft-Büros, offene Arbeitsbereiche und Shared Offices in
                Berlin-Friedrichshain erfordern individuelle Reinigungslösungen.
                Unser Team kümmert sich um maßgeschneiderte Reinigungskonzepte für
                Startups in Friedrichshain.
              </p>
              <h3 className="mt-8 text-lg font-bold text-foreground">
                Vorteile unserer Büroreinigung für Startups in Berlin-Friedrichshain:
              </h3>
              <ul className="mt-4 space-y-3 text-foreground/80">
                {[
              ...
              <Link
                ...
                className="mt-8 inline-flex items-center gap-2 text-base font-semibold text-orange hover:underline"
              >
                Perfekte Reinigungslösungen für Startups in Berlin-Friedrichshain
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
          </div>
        ...
        {/* Services intro for Friedrichshain */}
        <section className="bg-background pt-20">
          <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
            ...
            <p className="mt-6 text-base leading-relaxed text-foreground/75">
              ...
              in Berlin-Friedrichshain. Egal ob in der lebendigen Simon-Dach-Straße,
              rund um den Boxhagener Platz oder in der Nähe der East Side Gallery –
              wir sorgen für eine saubere und hygienische Arbeitsumgebung. Unsere
              Reinigungsdienste sind exakt auf die spezifischen Bedürfnisse Ihres
              Büros in Friedrichshain zugeschnitten.
            </p>
            <Button
              asChild
              className="mt-8 h-14 rounded-full bg-orange pl-7 pr-2 text-base font-semibold text-primary-foreground hover:bg-orange-hover"
          ...
          <img
            src={cleanOffice}
            alt="Büroreinigung in Berlin-Friedrichshain — sauberes Büro nach professioneller Reinigung"
            loading="lazy"
            width={1280}
            height={960}
